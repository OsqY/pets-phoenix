defmodule PetsWeb.PostLive.Show do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <.header>
        ...
        <:actions>
          ...
          <.button variant="primary" navigate={~p"/posts/#{@post}/editar?return_to=show"}>
      ...
      <.list>
        ...
        <:item title="Fecha">{@post.fecha}</:item>
        <:item title="Mascota">{@post.mascota_id}</:item>
        <:item title="Usuario">{@post.usuario_id}</:item>
      </.list>
    </Layouts.app>
    """
  end
  ...
  @impl true
  def handle_info(
        {:updated, %Pets.Posts.Post{id: id} = post},
