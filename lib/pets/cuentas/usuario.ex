defmodule Pets.Cuentas.Usuario do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Pets.Repo)
  ...
  """
  def valid_password?(%Pets.Cuentas.Usuario{hashed_password: hashed_password}, password)
