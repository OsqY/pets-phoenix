defmodule PetsWeb.PostLiveTest do
  use PetsWeb.ConnCase

  import Phoenix.LiveViewTest
  import Pets.PostsFixtures

  @create_attrs %{usuario_id: 42, content: "some content", fecha: "2025-10-29", mascota_id: 42}
  @update_attrs %{usuario_id: 43, content: "some updated content", fecha: "2025-10-30", mascota_id: 43}
