defmodule PetsWeb.UserControllerTest do
  ...
  @create_attrs %{nombres: "some nombres", apellidos: "some apellidos", correo: "some correo", nombre_usuario: "some nombre_usuario"}
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated nombres"
    end
